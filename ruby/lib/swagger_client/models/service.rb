...
module SwaggerClient
  ...
  class Service
    ...
    attr_accessor :application_process
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'application_process')
        self.application_process = attributes[:'application_process']
      end
      ...
      if attributes.has_key?(:'taxonomy_ids')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          email == o.email &&
          status == o.status &&
          application_process == o.application_process &&
    ...
    def hash
      [id, organization_id, location_id, program_id, name, alternate_name, description, url, email, status, application_process, wait_time, taxonomy_ids].hash
    end
