...
describe 'LocationsApi' do
  ...
  # unit tests for find_nearby_locations
  ...
  describe 'find_nearby_locations test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for retrieve_location
  # Location
  ...
  # @param [Hash] opts the optional parameters
  # @return [Array<Location>]
  describe 'retrieve_location test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for retrieve_location_services
  # Services
  ...
  describe 'retrieve_location_services test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for retrieve_locations
  # Locations
  ...
  # @return [Array<Location>]
  describe 'retrieve_locations test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
