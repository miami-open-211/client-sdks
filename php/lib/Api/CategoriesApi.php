...
class CategoriesApi
{
     ...
     */
    public function getCategories($accept)
    {
        list($response) = $this->getCategoriesWithHttpInfo($accept);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getCategoriesWithHttpInfo($accept)
    {
        // verify the required parameter 'accept' is set
        if ($accept === null) {
            throw new \InvalidArgumentException('Missing the required parameter $accept when calling getCategories');
        }
        // parse inputs
