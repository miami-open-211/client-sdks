...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MiamiOpen211Api.Organization();
  });
  ...
  describe('Organization', function() {
    it('should create an instance of Organization', function() {
      ...
      //var instane = new MiamiOpen211Api.Organization();
      //expect(instance).to.be.a(MiamiOpen211Api.Organization);
    });
    ...
    it('should have the property taxStatus (base name: "tax_status")', function() {
    ...
    it('should have the property yearIncorporated (base name: "year_incorporated")', function() {
      // uncomment below and update the code to test the property yearIncorporated
      //var instane = new MiamiOpen211Api.Organization();
      //expect(instance).to.be();
    });

    it('should have the property legalStatus (base name: "legal_status")', function() {
