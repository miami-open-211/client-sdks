...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MiamiOpen211Api.SearchApi();
  });
  ...
  describe('SearchApi', function() {
    describe('searchLocations', function() {
      it('should call searchLocations successfully', function(done) {
        //uncomment below and update the code to test searchLocations
        //instance.searchLocations(pet, function(error) {
